...
@ApiResponses(value = {
        @ApiResponse(
                responseCode = HTTP_BAD_REQUEST_CODE,
        ...
        @ApiResponse(
                responseCode = SC_REQUEST_URI_TOO_LONG_CODE,
        ...
        @ApiResponse(
                responseCode = HTTP_GATEWAY_TIMEOUT_CODE,
